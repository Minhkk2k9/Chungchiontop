...
${message}`;
          ...
          // Đơn hàng sẽ tự động được đánh dấu là đã duyệt
          ...
          const qrPaymentHTML = `
              <div id="qrPaymentForm" class="form-container qr-payment">
                  ...
                  <div class="bank-info">
                      ...
                      <p><strong>Nội dung CK:</strong> DH${orderId}</p>
                  </div>
                  <div class="qr-code">
                      <img src="https://qr.sepay.vn/img?acc=0374249125&bank=MBBank&amount=${data.amount.replace(/\D/g, '')}&des=DH${orderId}&template=only_qr" alt="QR Code">
                  </div>
